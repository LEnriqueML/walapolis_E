...
class IdeasTest < ApplicationSystemTestCase
  ...
  test "creating a Idea" do
    ...
    fill_in "Benefits", with: @idea.benefits
    fill_in "Body", with: @idea.body
    fill_in "Estimated Time", with: @idea.estimated_time
    fill_in "Initial Cost", with: @idea.initial_cost
    fill_in "Monthly Cost", with: @idea.monthly_cost
    fill_in "Slug", with: @idea.slug
